...
class AppPreferences(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_PARTICIPANT_TOKEN = "participant_token"
        private const val KEY_LAST_SYNC = "last_sync"
        private const val KEY_STUDY_START_DATE = "study_start_date"
    }
    
    fun setUserInfo(name: String, anonymousId: String, participantToken: String) {
        prefs.edit().apply {
            putString(KEY_USER_NAME, name)
            putString(KEY_ANONYMOUS_ID, anonymousId)
            putString(KEY_PARTICIPANT_TOKEN, participantToken)
    ...
    fun getParticipantToken(): String = prefs.getString(KEY_PARTICIPANT_TOKEN, "") ?: ""
